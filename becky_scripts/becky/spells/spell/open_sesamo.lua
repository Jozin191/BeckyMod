...
BeckyMod:AddCallback(ModCallbacks.MC_POST_LASER_UPDATE, function(_, laser)
    if laser:GetData().OpenSesamo_LaserInfo then
        ...
        laser:GetData().OpenSesamo_LaserInfo = nil
    end    
end)
