...
---@return TearFlags
---@function
function BeckyMod:TearFlag(bitmaskOffset)
...
---@return string[]
function BeckyMod:GetNamesInBitmask(flagTable, bitmask, maxInt)
	local names = {}
	local inv = Invert(flagTable)
	for i = 0, maxInt do
...
function BeckyMod:HasBitFlags(flags, checkFlag)
...
---@param flags flag
---@param checkFlag flag
function BeckyMod:HasAnyBitFlags(flags, checkFlag)
...
---@param addFlag flag
---@return flag
function BeckyMod:AddBitFlags(flags, addFlag)
	flags = flags | addFlag
	return flags
end
...
---@return flag
function BeckyMod:RemoveBitFlags(flags, removeFlag)
